...
public class TestIterator {
  ...
  public void testRemove() {
    ...
    assertEquals(List.of(33, 44, 55, 66), list);// TODO using assertEquals and List.of, express which values are left in the list
  ...
  public void testAverageValues() {
    ...
    while (iterator.hasNext()) {
      sum += iterator.next();  // Add the current element to sum
