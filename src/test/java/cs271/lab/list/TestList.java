...
public class TestList {
  ...
  // TODO write assertions using
    list.add(77);// list.contains(77)
    assertTrue("List should contain 77 after adding it", list.contains(77));// that hold before and after adding 77 to the list
  ...
  public void testContainsAll() {
    ...
    assertTrue(list.containsAll(List.of(33, 77, 44, 55, 66)));// 1) assert that list contains all five different numbers added
  ...
  public void testAddAll() {
    list.addAll(List.of(33, 77, 44, 77, 55, 77, 66));// TODO in a single statement using addAll and List.of,
  ...
  public void testRemoveAll() {
    ...
    list.add(77);
    list.add(66);
    list.removeAll(List.of(33, 44, 55, 66));// TODO in a single statement using removeAll and List.of,
  ...
  public void testRetainAll() {
    ...
    list.add(77);
    list.add(66);
    list.retainAll(List.of(77));// TODO in a single statement using retainAll and List.of,
    // remove items from the list to make the following assertions pass
    // (without touching the assertions themselves)
    assertEquals(3, list.size());
    assertEquals(List.of(77, 77, 77), list);
  ...
  public void testSet() {
    ...
    list.set(1, 99);  // Replace 77 at index 1 with 99
    list.set(3, 99);  // Replace 77 at index 3 with 99
    list.set(5, 99);  // Replace 77 at index 5 with 99// TODO use the set method to change specific elements in the list
